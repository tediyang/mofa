  ...
  v(window).on("load", function () {
    ...
    jQuery(document).ready(function () {
      ...
      objectFitImages(),
        ...
        (function () {
          var popover_btn = v(".section.text-section button");
          var popover = v("#sponsor-popover");
          var close_btn = v("#sponsor-popover .aside-dropdown__close");

          popover_btn.on("click", function (e) {
        ...
        (function () {
          ...
          var e = v(".footer-copyright");
          e.text(`Copyright © ${year} Mofa Foundation. All rights reserved.`);
        })();
        (function () {
          v('.upcoming-item__description').each(function() {
            var p = v('.mini');
            var text = p.text();
        
            if (text.length > 80) {
              p.text(text.substring(0, 80) + "...");
            }
          });
        })();
    });
